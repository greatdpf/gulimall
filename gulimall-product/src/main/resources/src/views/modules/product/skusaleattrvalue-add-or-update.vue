<template>
  <el-dialog
    ...
    <el-form-item label="é”€å”®å±žæ€§å" prop="attrName">
      <el-input v-model="dataForm.attrName" placeholder="é”€å”®å±žæ€§å"></el-input>
    </el-form-item>
    <el-form-item label="é”€å”®å±žæ€§å€¼" prop="attrValue">
      <el-input v-model="dataForm.attrValue" placeholder="é”€å”®å±žæ€§å€¼"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          attrName: [
            { required: true, message: 'é”€å”®å±žæ€§å不能为空', trigger: 'blur' }
          ],
          attrValue: [
            { required: true, message: 'é”€å”®å±žæ€§å€¼不能为空', trigger: 'blur' }
          ],
