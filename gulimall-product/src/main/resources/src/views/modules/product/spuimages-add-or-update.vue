<template>
  <el-dialog
    ...
    <el-form-item label="å›¾ç‰‡å" prop="imgName">
      <el-input v-model="dataForm.imgName" placeholder="å›¾ç‰‡å"></el-input>
    </el-form-item>
    <el-form-item label="å›¾ç‰‡åœ°å€" prop="imgUrl">
      <el-input v-model="dataForm.imgUrl" placeholder="å›¾ç‰‡åœ°å€"></el-input>
    </el-form-item>
    <el-form-item label="é¡ºåº" prop="imgSort">
      <el-input v-model="dataForm.imgSort" placeholder="é¡ºåº"></el-input>
    </el-form-item>
    <el-form-item label="æ˜¯å¦é»˜è®¤å›¾" prop="defaultImg">
      <el-input v-model="dataForm.defaultImg" placeholder="æ˜¯å¦é»˜è®¤å›¾"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          imgName: [
            { required: true, message: 'å›¾ç‰‡å不能为空', trigger: 'blur' }
          ],
          imgUrl: [
          ...
          defaultImg: [
            { required: true, message: 'æ˜¯å¦é»˜è®¤å›¾不能为空', trigger: 'blur' }
          ]
        }
      }
    },
