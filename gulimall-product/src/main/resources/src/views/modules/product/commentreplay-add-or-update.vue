<template>
  <el-dialog
    ...
    <el-form-item label="è¯„è®ºid" prop="commentId">
      <el-input v-model="dataForm.commentId" placeholder="è¯„è®ºid"></el-input>
    </el-form-item>
    <el-form-item label="å›žå¤id" prop="replyId">
      <el-input v-model="dataForm.replyId" placeholder="å›žå¤id"></el-input>
    </el-form-item>
    </el-form>
  ...
  export default {
    data () {
      return {
        ...
        dataRule: {
          commentId: [
            { required: true, message: 'è¯„è®ºid不能为空', trigger: 'blur' }
          ],
          replyId: [
            { required: true, message: 'å›žå¤id不能为空', trigger: 'blur' }
          ]
        }
      }
    },
