<template>
  <el-dialog
    ...
    <el-form-item label="åˆ†ç±»id" prop="catelogId">
      <el-input v-model="dataForm.catelogId" placeholder="åˆ†ç±»id"></el-input>
    </el-form-item>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          catelogId: [
            { required: true, message: 'åˆ†ç±»id不能为空', trigger: 'blur' }
          ],
          brandName: [
