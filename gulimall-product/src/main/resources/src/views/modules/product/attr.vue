  ...
  <div class="mod-config">
    ...
    <el-table
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="æ˜¯å¦éœ€è¦æ£€ç´¢[0-ä¸éœ€è¦ï¼Œ1-éœ€è¦]">
      </el-table-column>
      <el-table-column
        prop="icon"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="å¯é€‰å€¼åˆ—è¡¨[ç”¨é€—å·åˆ†éš”]">
      </el-table-column>
      <el-table-column
        prop="attrType"
        header-align="center"
        align="center"
        label="å±žæ€§ç±»åž‹[0-é”€å”®å±žæ€§ï¼Œ1-åŸºæœ¬å±žæ€§ï¼Œ2-æ—¢æ˜¯é”€å”®å±žæ€§åˆæ˜¯åŸºæœ¬å±žæ€§]">
      </el-table-column>
      <el-table-column
        prop="enable"
        header-align="center"
        align="center"
        label="å¯ç”¨çŠ¶æ€[0 - ç¦ç”¨ï¼Œ1 - å¯ç”¨]">
      </el-table-column>
      <el-table-column
        prop="catelogId"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="å¿«é€Ÿå±•ç¤ºã€æ˜¯å¦å±•ç¤ºåœ¨ä»‹ç»ä¸Šï¼›0-å¦ 1-æ˜¯ã€‘ï¼Œåœ¨skuä¸­ä»ç„¶å¯ä»¥è°ƒæ•´">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
